<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        ...
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">Gratuit<small class="text-muted">/ mois</small></h1>
        ...
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">8,99 € <small class="text-muted">/ mois</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>20 crédits</li>
              <li>15 % de remise sur les photos</li>
            </ul>
        ...
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">18,99 € <small class="text-muted">/ mois</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>60 crédits</li>
